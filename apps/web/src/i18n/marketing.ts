    ...
    layers: [
      {
        ...
        strengths: [
          ...
          'Complete self-owned stack from cryptography to transport, no third-party TLS library',
        ],
        limits: [
          'Alpha software and CLI only today; purpose-built protocol not compatible with legacy node formats.',
    ...
    layers: [
      {
        ...
        strengths: [
          ...
          '设计上具备探测抵抗，时序对齐路径',
          '从密码学到传输层完全自研，不依赖第三方 TLS 库',
        ],
        limits: [
          '目前是 alpha 阶段的纯命令行工具，自研协议不兼容旧节点格式。',
    ...
    layers: [
      {
        ...
        strengths: [
          ...
          '從密碼學到傳輸層完全自研，不依賴第三方 TLS 庫。',
        ],
        limits: [
          '目前是 alpha 階段的純命令列工具，自研協定不相容舊節點格式。',
    ...
    layers: [
      {
        ...
        strengths: [
          ...
          'Pile entièrement propriétaire de la cryptographie au transport, sans bibliothèque TLS tierce.',
        ],
        limits: [
          'Alpha en ligne de commande uniquement ; protocole conçu pour un cas d\'usage précis, non compatible avec les formats de nœuds hérités.',
    ...
    layers: [
      {
        ...
        strengths: [
          ...
          'Pila completamente propia desde la criptografía hasta el transporte, sin biblioteca TLS de terceros',
        ],
        limits: [
          'Alpha y solo de línea de comandos por ahora; protocolo diseñado para un modelo de amenaza específico, no compatible con formatos de nodo heredados.',
    ...
    layers: [
      {
        ...
        strengths: [
          ...
          '暗号からトランスポートまで完全自社実装、サードパーティ TLS ライブラリ不使用',
        ],
        limits: [
          '現時点では alpha の CUI 専用で、独自プロトコルは旧形式ノードと互換性がありません。',
    ...
    layers: [
      {
        ...
        strengths: [
          ...
          'Pila completament pròpia des de la criptografia fins al transport, sense biblioteca TLS de tercers',
        ],
        limits: [
          'Alfa i només de línia d\'ordres per ara; protocol dissenyat per a un model d\'amenaça específic, no compatible amb formats de node heretats.',
