...
## 1. Chinese master and localization

- [x] 1.1 Apply Chinese marketing and 18 article drafts; verify all article IDs, examples and configuration fields remain present.
- [x] 1.2 Rewrite the other six language editions; verify 126 articles, equivalent technical conditions and complete dictionaries.
- [x] 1.3 Align links, clipboard labels, metadata and sharing text; verify destinations and accessible labels.
